...
class DatasetConfig(BaseDataclass):
    ...
    num_workers: int = field(default=0, metadata={"help": "how many subprocesses to use for data loading"})
...
class OFATask:
    def __init__(self, cfg: TaskConfig = None, **kwargs):
        ...
        self.diffuser_args = None  # accessed by the diffusion criterion and generator
